...
#define HOLD_MS        20000UL           // 움직임 후 화면 켜둘 시간
...
void loop() {
  ...
  bool wantOn = (now - lastMotion) < HOLD_MS;
  ...
  // 시각 표시 (콜론 고정). 내부 시계 기준이라 인터넷 끊겨도 계속 나옴
